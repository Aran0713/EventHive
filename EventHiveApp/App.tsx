  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.ScrollView
        ...
        //onScroll={Animated.event([{ nativeEvent: { contentOffset: { x: mapAnimation } } }], { useNativeDriver: false })}
        ...
        {Markers.map((Marker, index) =>
          <View style={styles.eventCard} key={index}>
            <View style={styles.eventTextContent}>
              ...
              <Text numberOfLines={1} style={styles.eventDateTime}>{Marker.date}, {Marker.time}</Text>
